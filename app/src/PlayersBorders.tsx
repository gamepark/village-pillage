...
const bordersPlayers = [
    ...
    [{height: 26, width: 0.2, top: 7, left: 44, transOrigin: "bottom", skewX: 55},{height: 40, width: 0.2, top: 60, left: 44, transOrigin : "top", skewX: -45, zIndex: 3},{height: 26, width: 0.2, top: 7, left: 132, transOrigin: "bottom", skewX: 125},{height: 40, width: 0.2, top: 60, left: 132, transOrigin: "top", skewX: 35}],
